			...
			<form id="aprofile" class="needs-validation" novalidate>
							...
							<div class="form-row">
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" name="id" class="form-control" id="validationCustom01" placeholder="Faculy Id" value="<?php if(mysqli_num_rows($query_run2) == 1){echo $student2['id'];} else{ echo "";}?>" required>
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="name" id="validationCustom02" placeholder="Faculty Name" value="<?php if(mysqli_num_rows($query_run2) == 1){echo $student2['name'];} else{ echo "";}?>" required>
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									...
									<select class="form-control" name="design" id="pstatuss" required>
										...
										<option value="Assistant Professor"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['design']=="Assistant Professor") echo 'selected="selected"';} else{ echo "";}?>>Assistant Professor</option>
										<option value="Associate Professor"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['design']=="Associate Professor") echo 'selected="selected"';} else{ echo "";}?>>Associate Professor</option>
										<option value="Professor"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['design']=="Professor") echo 'selected="selected"';} else{ echo "";}?>>Professor</option>
										<option value="Lab Instructor"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['design']=="Lab Instructor") echo 'selected="selected"';} else{ echo "";}?>>Lab Instructor</option>
									  </select>
									  <div class="valid-feedback">
										Looks good!
									  </div>
							...
							<div class="form-row">
									...
									<select class="form-control" name="role" id="pstatuss" required>
										<option value="">Select role</option>
										<option value="Faculty"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['role']=="Faculty") echo 'selected="selected"';} else{ echo "";}?>>Faculty</option>
										<option value="HOD"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['role']=="HOD") echo 'selected="selected"';} else{ echo "";}?>>HOD</option>
										<option value="Principal"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['role']=="Principal") echo 'selected="selected"';} else{ echo "";}?>>Principal</option>
										<option value="Lab Instructor"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['role']=="Lab Instructor") echo 'selected="selected"';} else{ echo "";}?>>Lab Instructor</option>
									  </select>									  
									  <div class="valid-feedback">
										Looks good!
									  </div>
									...
									<select class="form-control" name="dept" id="pstatuss" required>
										...
										<option value="Artificial Intelligence and Data Science"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Artificial Intelligence and Data Science") echo 'selected="selected"';} else{ echo "";}?>>Artificial Intelligence and Data Science</option>
										<option value="Artificial Intelligence and Machine Learning"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Artificial Intelligence and Machine Learning") echo 'selected="selected"';} else{ echo "";}?>>Artificial Intelligence and Machine Learning</option>
										<option value="Civil Engineering"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Civil Engineering") echo 'selected="selected"';} else{ echo "";}?>>Civil Engineering</option>
										<option value="Computer Science and Business Systems"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Computer Science and Business Systems") echo 'selected="selected"';} else{ echo "";}?>>Computer Science and Business Systems</option>
										<option value="Computer Science and Engineering"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Computer Science and Engineering") echo 'selected="selected"';} else{ echo "";}?>>Computer Science and Engineering</option>
										<option value="Electrical and Electronics Engineering"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Electrical and Electronics Engineering") echo 'selected="selected"';} else{ echo "";}?>>Electrical and Electronics Engineering</option>
										<option value="Electronics and Communication Engineering"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Electronics and Communication Engineering") echo 'selected="selected"';} else{ echo "";}?>>Electronics and Communication Engineering</option>
										<option value="Information Technology"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Information Technology") echo 'selected="selected"';} else{ echo "";}?>>Information Technology</option>
										<option value="Civil Engineering"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Civil Engineering") echo 'selected="selected"';} else{ echo "";}?>>Civil Engineering</option>
										<option value="Mechanical Engineering"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Mechanical Engineering") echo 'selected="selected"';} else{ echo "";}?>>Mechanical Engineering</option>
										<option value="Master of Business Administration"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Master of Business Administration") echo 'selected="selected"';} else{ echo "";}?>>Master of Business Administration</option>
										<option value="Master of Computer Applications"<?php if(mysqli_num_rows($query_run2) == 1){if($student2['dept']=="Master of Computer Applications") echo 'selected="selected"';} else{ echo "";}?>>Master of Computer Applications</option>
									  </select>									  
									  <div class="valid-feedback">
										Looks good!
									  </div>
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="date" class="form-control" name="doj" id="validationCustom02" placeholder="Last Name" value="<?php if(mysqli_num_rows($query_run2) == 1){echo $student2['doj'];} else{ echo "";}?>" required>
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
	...
	?>	
							...
							<div class="form-row">
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" name="oid" class="form-control" id="validationCustom01" placeholder="ORCID" value="<?php if(mysqli_num_rows($query_run) == 1){echo $oid;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="sid" id="validationCustom02" placeholder="Scopus ID" value="<?php if(mysqli_num_rows($query_run) == 1){echo $sid;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="rid" id="validationCustom02" placeholder="Researcher ID" value="<?php if(mysqli_num_rows($query_run) == 1){echo $rid;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
							...
							<div class="form-row">
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" name="gsid" class="form-control" id="validationCustom01" placeholder="Google Scholar ID" value="<?php if(mysqli_num_rows($query_run) == 1){echo $gsid;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="hid" id="validationCustom02" placeholder="H-Index" value="<?php if(mysqli_num_rows($query_run) == 1){echo $hid;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="iid" id="validationCustom02" placeholder="i10-Index" value="<?php if(mysqli_num_rows($query_run) == 1){echo $iid;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
							...
							<div class="form-row">
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" name="gi" class="form-control" id="validationCustom01" placeholder="G-Index" value="<?php if(mysqli_num_rows($query_run) == 1){echo $gi;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="cs" id="validationCustom02" placeholder="Citations Scopus" value="<?php if(mysqli_num_rows($query_run) == 1){echo $cs;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
									...
									<div class="col-md-4 mb-3">
									  ...
									  <input type="text" class="form-control" name="cgs" id="validationCustom02" placeholder="Citations Google Scholar" value="<?php if(mysqli_num_rows($query_run) == 1){echo $cgs;} else{ echo "";}?>" >
									  <div class="valid-feedback">
										Looks good!
									  </div>
									</div>
