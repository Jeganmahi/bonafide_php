                    ...
                    <div class="card-body wizard-content">
						...
						<div class="card">
                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#messages" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i class="bi bi-people-fill"></i><b> Counselling Details</b></span></a> </li>
        ...
        <form id="saveStudent">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="course" id="course" onchange="if(this.value!='PHD'){this.form['score'].style.visibility='visible'}else {this.form['score'].style.visibility='hidden'};" required>           
				...
				<div class="mb-3">
                    ...
                    <select class="form-control" name="cs" onchange="if(this.value=='Completed'){this.form['yc'].style.visibility='visible',this.form['score'].style.visibility='visible'}else {this.form['yc'].style.visibility='hidden',this.form['score'].style.visibility='hidden'};" required>           
 						<option value="">Select</option>
				...
				<div class="mb-3">
                    <label for="">Certification Number *</label><br>
					<p> (for PHD Pursuing : Enter provisional Reg order num) </p>
				...
				<div class="mb-3">
					...
					<p> (for PHD Pursuing : upload provisional Reg order) </p>
					 <div class="input-group">
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><b>Mark </b></th>
								<th align="center"><b>View Certificate</b></th>
						...
						<div class="modal-content">
                                ...
                                <form id="cform">
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" name="cform" id="cform"class=" cform btn btn-primary">Add member</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table id="myTable1" class="table table-bordered table-striped">
                        ...
                        <tbody>
    <?php
    $query = "SELECT * FROM counselling where id='$s'";
    $query_run = mysqli_query($db, $query);
        ...
        foreach ($query_run as $student) {
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    <button type="submit" value="<?= $student['uid']; ?>" class="deletedetails btn btn-danger">Delete</button>
                <?php } ?>
                </td>
            </tr>
            <?php
